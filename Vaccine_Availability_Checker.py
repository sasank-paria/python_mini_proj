...
# Labels
label_date_now = Label(text="Current Date", bg = top_right_frame_bg, font = 'TimesRoman 12 bold')
label_date_now.place(x=20, y=40)

label_time_now = Label(text="Current Time", bg = top_right_frame_bg, font = 'TimesRoman 12')
label_time_now.place(x=20, y=60)

label_pincode = Label(text="Pincode", bg = top_right_frame_bg, font = 'TimesRoman 11')
label_pincode.place(x=220, y=15)

label_date = Label(text="Date", bg = top_right_frame_bg, font = 'TimesRoman 11')
label_date.place(x=380, y=15)

label_dateformat = Label(text="[DD-MM-YYYY]", bg = top_right_frame_bg, font = 'TimesRoman 7')
